 ...
 * Examples:
 *
 *   app.phase(locomotive.boot.httpsServer(8080, {key: fs.readFileSync('...'), cert: fs.readFileSync('...')}));
 *
 *   app.phase(locomotive.boot.httpsServer(8080, '127.0.0.1', {key: fs.readFileSync('...'), cert: fs.readFileSync('...')}));
 *
 *   app.phase(locomotive.boot.httpsServer({ address: '127.0.0.1', port: 8080, key: fs.readFileSync('...'), cert: fs.readFileSync('...')}));
 *
 * @param {Number} port
