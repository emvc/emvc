 ...
 * Examples:
 *
 *   app.phase(locomotive.boot.httpsServerCluster(8080, { key: fs.readFileSync('...'), cert: fs.readFileSync('...') }));
 *
 *   app.phase(locomotive.boot.httpsServerCluster(8080, '127.0.0.1', { key: fs.readFileSync('...'), cert: fs.readFileSync('...') }));
 *
 *   app.phase(locomotive.boot.httpsServerCluster(8080, '127.0.0.1', { size: 8, key: fs.readFileSync('...'), cert: fs.readFileSync('...') }));
 *
 * @param {Number} port
