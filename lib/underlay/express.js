 ...
 * Express underlay.
 *
 * This module sets up an underlying Express app for the emvc application.
 *
 * emvc is just a collection of higher-level constructs layered on top of
...
module.exports = function(env) {
  ...
  this.__router.define(function(method, path, handler) {
    self.router[method === 'del' ? 'delete' : method](path, handler);
  });
  ...
  // Forward function calls from emvc to Express.  This allows emvc
