...
exports.acceptsArray = function(types, str) {
  ...
  return exports._accepts(types, str, types[0], false);
};

exports._accepts = function(types, str, defaultValue, via) {
...
exports.acceptedViaArray = function(types, str) {
  return exports._accepts(types, str, undefined, true);
};
